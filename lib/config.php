...
define('DB_USER','shadowsocksR');
define('DB_PWD','shadowsocksR');
define('DB_DBNAME','shadowsocksR');
...
//name
$site_name = "shadowsocksR Azure";
$site_url  = "http://shadowsocksR.azurewebsites.net/";
/**
 * 站点盐值，用于加密密码
